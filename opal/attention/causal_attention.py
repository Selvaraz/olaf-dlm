...
class CausalAttention(nn.Module):
    def __init__(self, d_in, d_out,  context_len=128, dropout_percent=0.1, qkv_bias=False):
        ...
        # The following will initialize the necessary parameters for the causal attention mechanism.
        # Dropout layer to prevent overfitting, the dropout_percent means it will randomly set some of the
        # attention weights to zero during training.
    ...
    def forward_self_attention(self, x):
        ...
        attention_scores.masked_fill_(self.mask.bool()[:sequence_length, :sequence_length], -torch.inf)
        ...
        # The dropout layer will randomly set some of the attention weights to zero during training.
        # This helps to improve the generalization of the model.
        # The dropout rate is set to 0.1 by default, which means 10% of the attention weights
        # will be randomly set to zero during training.
        # This is done to prevent overfitting and improve the generalization of the model.
        # The dropout layer is applied after the attention weights are computed,
        # before they are used to compute the context vector.
