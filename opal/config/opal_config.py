...
GPT_CONFIG_OPAL_FINETUNE_45M = {
    ...
    # Optional-LoRA-Finetune: LoRA configuration for optional fine-tuning LoRA
    "use_lora": False,               # Optional-LoRA-Finetune: Disable by default for traditional fine-tuning
    "lora_rank": 8,                  # Optional-LoRA-Finetune: Smaller rank for fine-tuning efficiency
    "lora_alpha": 16,                # Optional-LoRA-Finetune: Corresponding alpha value
    "lora_dropout": 0.05,            # Optional-LoRA-Finetune: Lower dropout for fine-tuning stability
    "target_modules": ["Wq", "Wk", "Wv", "out_proj"],  # Optional-LoRA-Finetune: attention modules
    "lora_include_mlp": False,       # Optional-LoRA-Finetune: MLP LoRA inclusion flag
}
...
_PHASE_CONFIGS = {
    ...
    "fine_tuning": {
        **GPT_CONFIG_OPAL_FINETUNE_45M,
        ...
        # Optional-LoRA-Finetune: LoRA settings inherited from GPT_CONFIG_OPAL_FINETUNE_45M
        # Optional-LoRA-Finetune: use_lora, lora_rank, lora_alpha, lora_dropout, target_modules, lora_include_mlp
    }
}
...
_TRAINING_CONFIGS = {
    ...
    "fine_tuning": {
        **_TRAINING_CONFIG_GPU,
        ...
        "lora" : False                # Optional-LoRA-Finetune: Will be updated dynamically
    }
}
